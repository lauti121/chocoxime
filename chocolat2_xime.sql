...
-- Tiempo de generación: 17-06-2026 a las 13:06:30
...
(1, 'url_hero', 'https://images.unsplash.com/photo-1549007994-cb92caebd54b?auto=format&fit=crop&w=700&q=80'),
(2, 'url_nosotros', 'https://images.unsplash.com/photo-1606312619070-d48b4c652a52?auto=format&fit=crop&w=600&q=80');
...
CREATE TABLE `productos` (
  ...
  `precio_original` int(11) DEFAULT NULL,
...
CREATE TABLE `usuarios` (
  ...
  `metodo_auth` enum('google','email') DEFAULT 'google',
